...
<body style="overflow-y: hidden;" class="bg-default">
	<div class="panel container col-lg-4 col-md-6 col-sm-6 col-xs-10" style="margin: 30px; border-radius: 20px; align-content: center;">
        ...
        <div class="panel-heading bg-warning">
            <h4 style="color: white" class="animated zoomIn">ADMINISTRATOR</h4>
        </div>
        <div class="col-md-12 panel-body" >
                       <div class="col-md-11">
                        <form class="cmxform" method="POST">
                            ...
                            <input class="submit btn btn-warning col-lg-12 col-md-5 col-sm-5 col-xs-12" type="submit" value="Masuk" name="login_admin" style="margin-top: 10px;margin-left: 10px; height: 40px;">
                        </form>
                        <form class="cmxform" method="POST">
                             <input class="submit btn btn-danger col-lg-12 col-md-5 col-sm-5 col-xs-12" type="submit" value="Kembali" name="back" style="margin-top: 10px;margin-left: 10px; height: 40px;">
                        </form>
                    </div>
        </div>
    </div>
